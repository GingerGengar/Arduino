...
class LSM9DS1Class {
  public:
    ...
    // Combined Accel + Gyro
    void getIMU(float& ax, float& ay, float& az, float& gx, float& gy, float&gz); //combines accelerationAvailable, readAcceleration, gyroscopeAvailable, and readGyroscope
    void readIMU(float& ax, float& ay, float& az, float& gx, float& gy, float&gz); //combines readAcceleration and readGyroscope
    void burstReadIMU(float& ax, float& ay, float& az, float& gx, float& gy, float& gz); //combines readAcceleration and readGyroscope in burst mode
  private:
    bool continuousMode;
